...
organization-standardsに基づいたPR品質管理ワークフロー：

- **PR言語チェック**: PRのタイトルと説明文が日本語で記載されているかを自動検証
- **セルフレビューリマインダー**: PR作成者にセルフレビューの実施を促すリマインダー機能
- **PR説明品質ゲート**: PR説明の品質を組織標準に基づいて検証（必須セクション、文字数、チェックボックス確認率など）
